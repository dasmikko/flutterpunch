    ...
    children.toList().forEach((item) {
      if (item.attributes.isEmote) {
        textItems.add(ImageSpan(
              NetworkImage("https://files.facepunch.com/garry/e4f979d2-7c3f-476c-a893-23d1375c94e5.png"),
              imageWidth: 24,
              imageHeight: 24,
            ));
      } else {
        textItems.add(TextSpan(
          text: item.text,
          style: TextStyle(fontWeight: item.attributes.bold ? FontWeight.bold : null)
        ));
      }
    });
